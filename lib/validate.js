...
const createValidator = (
    ...
    const validate = ajv.compile({$schema: 'http://json-schema.org/draft-07/schema#', ...schema});
...
const withTrimmer = validator => data => validator(Object.prototype.toString.call(data) === "[object String]" ? data.trim() : data)

const manifest = createValidator(manifestSchema, { removeAdditional: true, useDefaults: true })
const uri = createValidator({type: 'string', pattern: manifestSchema.properties.content.pattern})
