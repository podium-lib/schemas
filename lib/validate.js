...
const createValidator = (
    ...
    return data => {
        ...
        return {value: data, error: !valid && ajv.errors};
    };
};

const manifest = createValidator(manifestSchema, { removeAdditional: true, useDefaults: true })
const uri = createValidator(uriFormat)
const name = createValidator(manifestSchema.properties.name)
const version = createValidator(manifestSchema.properties.version)
